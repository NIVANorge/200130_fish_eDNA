...
14.11.2022: Multiplied ng DNA by 10, because concentration of standards were wrongly adjusted to qubit value (NanoDrop was correct).
...
medeDNAconc_pinksal_finn <- medeDNAconc_pinksal 


#log(SQ_vol*1e11, base = 10)
#sqrt(SQ_vol*1e11)
...
medeDNAconc_pinksal_finn_map <- leaflet(medeDNAconc_pinksal_finn) %>% 
  ...
  addCircleMarkers(color = "red", radius = ~log(SQ_vol*10e8)) #%>% 
...
# four-element numeric vector specifying the top, left, width, and height
mapshot(medeDNAconc_pinksal_finn_map, file = "eDNAconc_pinksal_finn.png")
...
ragg::agg_png("saltrut_gje_corrected.png", width = 6, height = 2.5, units = "in", res = 300, scaling = 1.5)
 ...
 ragg::agg_png("saltrut_gje_wlm_corrected.png", width = 6, height = 2.5, units = "in", res = 300, scaling = 1.5)
 strut_wlm
 dev.off()
...
ragg::agg_png("anadromous_wlm_arr.png", width = 10, height = 12, units = "in", res = 300, scaling = 1.5)
 andro_wlm_arr
 dev.off()
